...
{
	[DefaultEvent("Click")]
	public class Button_Group : UserControl
	{
		...
		private ButtonBox_Group _BBox;

		private ButtonBox_Group _Parent;

		public ButtonData_Group _BtnData;
		...
		public bool ButtonPressed
		{
			...
			set
			{
				...
				if (_BtnData != null)
				{
					_BtnData.ButtonPressed_Group = value;
				}
			}
		}
		...
		public bool UseFlag
		{
			...
			set
			{
				...
				if (!bPress)
				{
					...
					{
						pnlBtn.Appearance.BackColor = _DisColor;
					}
					else
					{
		...
		public ButtonBox_Group LinkButtonBox_Group
		{
			get
			{
				return _BBox;
		...
		private void lblBtn_MouseDown(object sender, MouseEventArgs e)
		{
			...
			if (_BtnData != null)
			{
				_BtnData.ButtonPressed_Group = bPress;
			}
		}
