...
namespace Cmmn
{
    public class CModule
    {
        ...
        public static void LogSave(string sName, DisplayType pType, string sMes, string sTarget, string sDateTime = "")
        {
            ...
            string sStr = Cmmn.CModule.ToString(sMes);
        ...
        /// <summary>
        /// 해당 컨트롤 및 하위 컨트롤에서 이름으로 컨트롤을 찾아서 반환한다.
        /// </summary>
        /// <param name="con"></param>
        /// <returns></returns>
        public static Control FindControlByName(Control con, string ControlName)
        {
            if (con.Name == ControlName) return con;

            return _FindControlByName(con, ControlName);
        }

        private static Control _FindControlByName(Control con, string ControlName)
        {
            ...
            {
                d = _FindControlByName(c, ControlName);
