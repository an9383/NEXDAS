    ...
    public partial class DBForm : Form
    {
        ...
        public class classDBInfo
        {
            ...
            public classDBInfo(string sConnectionString, string sConnName = "", bool bEncrypt = true)
            {
                ...
                if (sConn != "")
                {
                    DbProviderFactory dataFactory = DbProviderFactories.GetFactory(Cmmn.CModule.GetAppSetting(Cmmn.CModule.sProvider, sConn));
        ...
        public DBForm(string sConnection, string sName)
        {
            ...
            bEncrypt = Cmmn.CModule.GetAppSetting("ENCRYTION", "YES") == "YES";

            if (sConnection == "")
            {
                dbinfo = new classDBInfo(Cmmn.CModule.sConnectionString, sName, bEncrypt);
            }
            else
            {
        ...
        protected virtual bool SaveEnvironment()
        {
            if (bDBConnectTest())
            {
                Cmmn.CModule.SetAppSetting(Cmmn.CModule.sConnectionString, dbinfo.GetConnectionString(bEncrypt));
                Cmmn.CModule.SetAppSetting("DBConnectionName", dbinfo.DB_Title);
