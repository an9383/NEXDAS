...
namespace NEXDAS
{
    public partial class DX0370 : BaseForm
    {
        #region [ MEMBER AREA ]
        private FormInfor FormInformation;

        private string sItemCodeSearch = "FRAME";
        ...
        #region [ FORM EVENT ]
        private void DX0370_Shown(object sender, EventArgs e)
        {
            CheckRecDate();
            ...
            try
            {
                ...
                switch (CModule.ToString(sender.Tag))
                {
                    case "Confirm":
                        if (Grid1.Row == null)
                        {
                            MessageBoxShow(Common.getLangText("제품번호를 선택 하세요.", "DAS"), MessageBoxButtons.OK);
                            return;
                        }
        ...
        private void Grid1_GridClick(object sender, zGrid.GridClickEventArg e)
        {
            ...
            if (Grid1.SelectProcedureName == "USP_DX0370_S1")
            {
                lblOrder.Text = CModule.ToString(e._row.Cells["LOTNO"].Value);
            }
            else
            {
        ...
        {
            this.lblTitle.Text = Common.getLangText("FRAME 선택", "DAS");
            lblWC_T.Text       = Common.getLangText("생산 작업장", "DAS");
            lblDate_T.Text     = Common.getLangText("조회 일자", "DAS");
            lblOrder_T.Text    = Common.getLangText("LOT 번호", "DAS");
            lblItem_T.Text     = Common.getLangText("시트 번호", "DAS");
            ...
            SetMessage(Common.getLangText("제품번호를 선택 하세요.", "DAS"));
        }
        ...
        private void SetButton()
        {
            ...
            btnConfirm[0, 0].Text = Common.getLangText("품목", "DAS") + "\r\n" + Common.getLangText("조회", "DAS");
            btnConfirm[0, 0].Tag = "Plan";
        ...
        private void SetGrid()
        {
            ...
            Grid1.SelectProcedureName = "USP_DX0370_S1";
        }
        ...
        private void DoSave()
        {
            ...
            try
            {
                helper.ExecuteNoneQuery("USP_DX0370_I1", CommandType.StoredProcedure
                , helper.CreateParameter("AS_PLANTCODE",      Common.SelectedWorkCenter.PlantCode, DbType.String, ParameterDirection.Input)
                ...
                //sSQL.Append("exec USP_DX0000_RUNSTOP ");
                ...
                helper2.ExecuteNoneQuery("USP_DX0000_RUNSTOP", CommandType.StoredProcedure
