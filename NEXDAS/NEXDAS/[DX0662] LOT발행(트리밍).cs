...
namespace NEXDAS
{
    public partial class DX0662 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        private void DX0662_Shown(object sender, EventArgs e)
        {
            CheckRecDate();
        ...
        private void DX0662_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (_srp != null)
