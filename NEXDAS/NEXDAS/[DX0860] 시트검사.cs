...
namespace NEXDAS
{
    public partial class DX0860 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0860_Shown(object sender, EventArgs e)
        {
            this.Refresh();
        ...
        private void Initialization()
        {
            ...
            btnExpand.BackgroundImage = (Image)Cmmn.Properties.Resources.ResourceManager.GetObject("DX0860_000");
        ...
        private void DoLotFind()
        {
            ...
            try
            {
                if (bCalled)
                {
                    ...
                    lblSheetID.Text = sCalledFrameNo;
                ...
                else
                {
                    ...
                    if (dtlot.Rows.Count > 0)
                    {
                        ...
                        lblSheetID.Text = CModule.ToString(dtlot.Rows[0]["LOTNO"]);
                    }
                    else
                    {
                        lblLOT.Text = "";
