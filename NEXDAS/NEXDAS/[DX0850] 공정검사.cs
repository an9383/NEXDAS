...
namespace NEXDAS
{
    public partial class DX0850 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0850_Shown(object sender, EventArgs e)
        {
            this.Refresh();
        ...
        private void Initialization()
        {
            ...
            btnExpand.BackgroundImage = (Image)Cmmn.Properties.Resources.ResourceManager.GetObject("DX0850_000");
        ...
        private void DoLotFind()
        {
            ...
            try
            {
                if (bCalled)
                {
                    ...
                    lblFrameNo.Text = sCalledSheetNo;
                    lblOrderNo.Text = sCalledOrderNo;
                ...
                else
                {
                    ...
                    if (dtlot.Rows.Count > 0)
                    {
                        ...
                        lblFrameNo.Text = CModule.ToString(dtlot.Rows[0]["LOTNO"]);
                    }
                    else
                    {
                        lblLOT.Text = "";
