...
namespace NEXDAS
{
    public partial class DX0310 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0310_Shown(object sender, EventArgs e)
        {
        ...
        private void SetButton()
        {
            ...
            btnMold.SelectProcedureName = "USP_DX0310_S1";
        ...
        private void DoSave()
        {
            ...
            try
            {
                helper.ExecuteNoneQuery("USP_DX0310_I1", CommandType.StoredProcedure
