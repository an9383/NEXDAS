...
namespace NEXDAS
{
    public partial class DX0660 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        private void DX0660_Shown(object sender, EventArgs e)
        {
            CheckRecDate();
        ...
        private void DX0660_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (_srp != null)
        ...
        private void DoSave()
        {
            ...
            try
            {
                ...
                string sBarcode = "";
                string sSheetID = lblSheetID.Text.Trim();
                ...
                if (bResult == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        _helper.ExecuteNoneQuery("USP_DX1610_I1", CommandType.StoredProcedure
                        ...
                        , _helper.CreateParameter("AS_LOTNO", Common.txtContent.Trim(), DbType.String, ParameterDirection.Input)
                    ...
                    try
                    {
                        ...
                        _helper.ExecuteNoneQuery("USP_DX1600_WC0013", CommandType.StoredProcedure
                        , _helper.CreateParameter("AS_PLANTCODE", Common.SelectedWorkCenter.PlantCode, DbType.String, ParameterDirection.Input)
                        , _helper.CreateParameter("AS_WORKCENTERCODE", CModule.ToString(lblWC.Tag), DbType.String, ParameterDirection.Input)
                        , _helper.CreateParameter("AS_ORDERNO", lblOrder.Text.Trim(), DbType.String, ParameterDirection.Input)
                        , _helper.CreateParameter("AS_LOTNO", Common.txtContent.Trim(), DbType.String, ParameterDirection.Input)
                        , _helper.CreateParameter("AS_SHEETID", sSheetID.Trim(), DbType.String, ParameterDirection.Input)
