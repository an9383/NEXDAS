...
namespace NEXDAS
{
    public partial class DX0330 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0330_Shown(object sender, EventArgs e)
        {
            this.Refresh();
            CheckRecDate();
            SetBarcodeArea();
            ...
            txtMaterialID.Value = sCalledSheetID;
        ...
        {
            txtMaterialID.Leave += UText_Leave;
            txtMaterialID.KeyPress += UText_KeyPress;
        }
        ...
        private void UText_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                try
                {
                    helper.ExecuteNoneQuery("USP_DX0330_I1", CommandType.StoredProcedure
                    ...
                    , helper.CreateParameter("AS_ORDERNO", txtMaterialID.Text.Trim(), DbType.String, ParameterDirection.Input)
                    , helper.CreateParameter("AS_ITEMCODE", "SHEET", DbType.String, ParameterDirection.Input)
                    , helper.CreateParameter("AS_LOTNO", txtMaterialID.Text.Trim(), DbType.String, ParameterDirection.Input)
            ...
            try
            {
                ...
                switch (CModule.ToString(sender.Tag))
                {
                    ...
                    case "Search":
                        ...
                        Grid1.SelectProcedureName = "USP_DX0330_S1";
                    ...
                    //    txtMaterialCount.Tag = "";
                    //    txtMaterialCount.Text = "";
                    ...
                    //    btnConfirm[0, 1].Text = Common.getLangText("초기화", "DAS");
                    //    btnConfirm[0, 1].Tag = "Init";
        ...
        private void Initialization()
        {
            ...
            lblOrder_T.Text    = Common.getLangText("프레임 번호", "DAS");
            lblItem_T.Text     = Common.getLangText("사이즈", "DAS");
        ...
        private void SetButton()
        {
            ...
            btnConfirm[0, 0].Text = Common.getLangText("원자재", "DAS") + "\r\n" + Common.getLangText("커팅", "DAS");
            btnConfirm[0, 0].Tag = "Confirm";
            ...
            //btnConfirm[0, 3].Text = Common.getLangText("초기화", "DAS");
            //btnConfirm[0, 3].Tag = "Init";
        ...
        private void DoFind()
        {
            ...
            //txtMaterialID.Text = sCalledSheetID;
            txtMaterialCount.Text  = "1";
        ...
        {
            sItemCodeSearch = txtMaterialCount.Text.Trim();
            DoFind();
            sItemCodeSearch = "";
        }
        ...
        private void txtFrameCount_DoubleClick(object sender, EventArgs e)
        {
            
            CloseProgress();
            txtMaterialCount.Focus();
        }
    }
}