...
namespace NEXDAS
{
    public partial class DX0300 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0300_Shown(object sender, EventArgs e)
        {
            CheckRecDate();
      ...
      //                  break;
        ...
        private void DoSave()
        {
            ...
            try
            {
                helper.ExecuteNoneQuery("USP_DX0300_I1", CommandType.StoredProcedure
                , helper.CreateParameter("AS_PLANTCODE",      Common.SelectedWorkCenter.PlantCode, DbType.String, ParameterDirection.Input)
