...
namespace NEXDAS
{
    public partial class DX0639 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0639_Shown(object sender, EventArgs e)
        {
        ...
        private void DoSave()
        {
            ...
            dx0850.bCalled = true;
            dx0850.Owner = this;
            dx0850.sCalledLot = sMatLOT;
            dx0850.sCalledSheetNo = sSheetNo;
            dx0850.sCalledOrderNo = sOrderNo;
            ...
            if (ShowDialogForm(dx0850) == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        sSQL.Append("exec USP_DX1000_WC0009 ");
                        ...
                        sSQL.Append(", @pOrderNo = '" + dx0850.sCalledOrderNo + "' ");
        ...
        private void btnWC_buttonChangeEvent(Button_Main sender, ButtonBox_Main.ButtonClickEventArg e)
        {
            ...
            if (btnWC.GetSelectedButtons().Count > 0)
            {
                ...
                SheetNo(CModule.ToString(btnWC.GetSelectedButtons()[0].Tag));
            }
        }

        #endregion

        private void SheetNo(string lblLOT)
        {
            string sSheetNo = string.Empty;
