...
namespace NEXDAS
{
    public partial class DX8000 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX8000_Shown(object sender, EventArgs e)
        {
		...
		private void Initialization()
        {
			...
			lblCycle_T.Text    = Common.getLangText("규격", "DAS");
        ...
        private void DoFind()
        {
            ...
            if (dt.Rows.Count >= 1)
            {
                ...
                lblSpec.Text = DBHelper.nvlString(dt.Rows[0]["SPEC"]);
