namespace NEXDAS
{
    partial class DX0510
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tlpDX0510.SuspendLayout();
			this.SuspendLayout();
			// 
			// grbBaseForm
			// 
			this.grbBaseForm.Controls.Add(this.tlpDX0510);
			// 
			// lblMachine
			// 
			this.lblMachine.BackColor = System.Drawing.Color.White;
			this.lblMachine.BackGradientStyle = Infragistics.Win.GradientStyle.None;
			this.lblMachine.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.lblMachine.ColorContent = System.Drawing.Color.White;
			this.lblMachine.ColorLabel = System.Drawing.Color.Empty;
			this.lblMachine.ColorReadOnly = System.Drawing.Color.Empty;
			this.tlpDX0510.SetColumnSpan(this.lblMachine, 3);
			this.lblMachine.Dock = System.Windows.Forms.DockStyle.Fill;
			this.lblMachine.Font = new System.Drawing.Font("맑은 고딕", 18F, System.Drawing.FontStyle.Bold);
			this.lblMachine.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(1)))), ((int)(((byte)(150)))), ((int)(((byte)(255)))));
			this.lblMachine.LabelType = Cmmn.zLabel.LabelTypeEnum.Content;
			this.lblMachine.Location = new System.Drawing.Point(968, 67);
			this.lblMachine.Margin = new System.Windows.Forms.Padding(0);
			this.lblMachine.MoveControl = null;
			this.lblMachine.Name = "lblMachine";
			this.lblMachine.Padding = new System.Windows.Forms.Padding(20, 0, 0, 0);
			this.lblMachine.Size = new System.Drawing.Size(567, 51);
			this.lblMachine.TabIndex = 152;
			this.lblMachine.TextHAlign = Infragistics.Win.HAlign.Left;
			this.lblMachine.TextVAlign = Infragistics.Win.VAlign.Middle;
			// 
			// lblMachine_T
			// 
			this.lblMachine_T.BackColor = System.Drawing.Color.WhiteSmoke;
			this.lblMachine_T.BackGradientStyle = Infragistics.Win.GradientStyle.Default;
			this.lblMachine_T.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			this.lblMachine_T.ColorContent = System.Drawing.Color.Empty;
			this.lblMachine_T.ColorLabel = System.Drawing.Color.WhiteSmoke;
			this.lblMachine_T.ColorReadOnly = System.Drawing.Color.Empty;
			this.lblMachine_T.Dock = System.Windows.Forms.DockStyle.Fill;
			this.lblMachine_T.Font = new System.Drawing.Font("맑은 고딕", 18F);
			this.lblMachine_T.ForeColor = System.Drawing.Color.Gray;
			this.lblMachine_T.LabelType = Cmmn.zLabel.LabelTypeEnum.Label;
			this.lblMachine_T.Location = new System.Drawing.Point(777, 67);
			this.lblMachine_T.Margin = new System.Windows.Forms.Padding(0);
			this.lblMachine_T.MoveControl = null;
			this.lblMachine_T.Name = "lblMachine_T";
			this.lblMachine_T.Size = new System.Drawing.Size(191, 51);
			this.lblMachine_T.TabIndex = 151;
			this.lblMachine_T.Text = "고장 설비";
			this.lblMachine_T.TextHAlign = Infragistics.Win.HAlign.Center;
			this.lblMachine_T.TextVAlign = Infragistics.Win.VAlign.Middle;
			// 
			// lblWC_T
			// 
			...
			this.tlpDX0510.SetColumnSpan(this.lblWC, 3);
			...
			// btnMachine
			// 
			this.btnMachine.AlarmColor = System.Drawing.Color.Empty;
			this.btnMachine.BackColor = System.Drawing.Color.Transparent;
			this.btnMachine.BackgroundColor = System.Drawing.Color.Empty;
			this.btnMachine.BackgroundColor2 = System.Drawing.Color.Empty;
			this.btnMachine.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
			this.btnMachine.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.btnMachine.ButtonBoxType = Cmmn.Common.ButtonBoxTypeEnum.Selection;
			this.btnMachine.ButtonInfo = null;
			this.btnMachine.ClickBackColor = System.Drawing.Color.Empty;
			this.tlpDX0510.SetColumnSpan(this.btnMachine, 12);
			this.btnMachine.CountX = 1;
			this.btnMachine.CountY = 1;
			this.btnMachine.CurrentPage = 0;
			this.btnMachine.DisableColor = System.Drawing.Color.Empty;
			this.btnMachine.DisplayImage = false;
			this.btnMachine.Dock = System.Windows.Forms.DockStyle.Fill;
			this.btnMachine.ExTag = "";
			this.btnMachine.Font = new System.Drawing.Font("맑은 고딕", 18F, System.Drawing.FontStyle.Bold);
			this.btnMachine.FontData = null;
			this.btnMachine.FontSize = 18F;
			this.btnMachine.HAlign = Infragistics.Win.HAlign.Center;
			this.btnMachine.Location = new System.Drawing.Point(19, 149);
			this.btnMachine.MainForm = false;
			this.btnMachine.Margin = new System.Windows.Forms.Padding(0);
			this.btnMachine.MarginIn = new System.Windows.Forms.Padding(0);
			this.btnMachine.MarginOut = new System.Windows.Forms.Padding(0);
			this.btnMachine.MsgAddText = null;
			this.btnMachine.MsgControl = null;
			this.btnMachine.Name = "btnMachine";
			this.btnMachine.PageControl = this.zLabelPage;
			this.btnMachine.ParmN = null;
			this.btnMachine.ParmT = null;
			this.btnMachine.ParmV = null;
			this.btnMachine.ProcedureT = System.Data.CommandType.StoredProcedure;
			this.tlpDX0510.SetRowSpan(this.btnMachine, 7);
			this.btnMachine.SelectCommand = null;
			this.btnMachine.SelectionMode = Cmmn.Common.SelectionModeEnum.Multiple;
			this.btnMachine.SelectProcedureName = null;
			this.btnMachine.Size = new System.Drawing.Size(1879, 683);
			this.btnMachine.TabIndex = 148;
			this.btnMachine.buttonChangeEvent += new Cmmn.ButtonBox_Main.ButtonChange(this.btnMachine_buttonChangeEvent);
			// 
			// lblItem
			// 
			...
			this.tlpDX0510.SetColumnSpan(this.lblItem, 3);
			...
			this.tlpDX0510.SetColumnSpan(this.lblOrder, 3);
			...
			// tlpDX0510
			// 
			this.tlpDX0510.ColumnCount = 14;
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 1F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 10F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 10F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 0.1F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 19.6F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 10F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 10F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 0.09999999F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 19.6F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 0.5000001F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 12F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 0.5000001F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 6.000001F));
			this.tlpDX0510.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 0.6F));
			this.tlpDX0510.Controls.Add(this.btnConfirm, 10, 1);
			this.tlpDX0510.Controls.Add(this.btnMachine, 1, 9);
			this.tlpDX0510.Controls.Add(this.lblMachine, 6, 4);
			this.tlpDX0510.Controls.Add(this.lblMachine_T, 5, 4);
			this.tlpDX0510.Controls.Add(this.lblOrder, 2, 4);
			this.tlpDX0510.Controls.Add(this.lblOrder_T, 1, 4);
			this.tlpDX0510.Controls.Add(this.lblItem, 6, 2);
			this.tlpDX0510.Controls.Add(this.lblItem_T, 5, 2);
			this.tlpDX0510.Controls.Add(this.lblWC, 2, 2);
			this.tlpDX0510.Controls.Add(this.lblWC_T, 1, 2);
			this.tlpDX0510.Controls.Add(this.lblLine_05, 1, 17);
			this.tlpDX0510.Controls.Add(this.lblLine_04, 1, 7);
			this.tlpDX0510.Controls.Add(this.lblLine_03, 1, 5);
			this.tlpDX0510.Controls.Add(this.lblLine_02, 1, 3);
			this.tlpDX0510.Controls.Add(this.lblLine_01, 1, 1);
			this.tlpDX0510.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tlpDX0510.Location = new System.Drawing.Point(1, 0);
			this.tlpDX0510.Margin = new System.Windows.Forms.Padding(0);
			this.tlpDX0510.Name = "tlpDX0510";
			this.tlpDX0510.RowCount = 19;
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 1.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.4F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 6F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.2F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 6F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.4F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 1.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 1.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 12.75F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 12.75F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.8F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.4F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.8F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 47F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 1.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.5F));
			this.tlpDX0510.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 0.5F));
			this.tlpDX0510.Size = new System.Drawing.Size(1918, 863);
			this.tlpDX0510.TabIndex = 163;
			// 
			// btnConfirm
			// 
			...
			this.tlpDX0510.SetColumnSpan(this.btnConfirm, 3);
			...
			this.tlpDX0510.SetRowSpan(this.btnConfirm, 5);
			...
			this.tlpDX0510.SetColumnSpan(this.lblLine_05, 12);
			...
			this.tlpDX0510.SetColumnSpan(this.lblLine_04, 12);
			...
			this.tlpDX0510.SetColumnSpan(this.lblLine_03, 8);
			...
			this.tlpDX0510.SetColumnSpan(this.lblLine_02, 8);
			...
			this.tlpDX0510.SetColumnSpan(this.lblLine_01, 8);
