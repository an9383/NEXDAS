...
namespace NEXDAS
{
    public partial class DX0900 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0900_Shown(object sender, EventArgs e)
        {
		...
		private void Initialization()
        {
            ...
            btnExpand.BackgroundImage = (Image)Cmmn.Properties.Resources.ResourceManager.GetObject("DX0900_000");
        ...
        private void SetButton()
        {
            ...
            btnCycle.SelectProcedureName = "USP_DX0900_S1";
        ...
        private void SetGrid()
        {
            ...
            Grid1.SelectProcedureName = "USP_DX0900_S2";
        }
            ...
            try
            {
                ...
                for (int i = 0; i < Grid1.Rows.Count; i++)
                {
                    if (CModule.ToString(Grid1.Rows[i].Cells["CHK"].Value) != "")
                    {
                        ...
                        helper.ExecuteNoneQuery("USP_DX0900_I1", CommandType.StoredProcedure
        ...
        private void CheckImage(int idx)
        {
            ...
            try
            {
                DataTable dtImage = helper.FillTable("USP_DX0900_S3", CommandType.StoredProcedure
                                  , helper.CreateParameter("AS_PLANTCODE",      Common.SelectedWorkCenter.PlantCode,                         DbType.String, ParameterDirection.Input)
        ...
        private void GetLastDate()
        {
            ...
            try
            {
                DataTable dtLastDate = helper.FillTable("USP_DX0900_S4", CommandType.StoredProcedure
                                     , helper.CreateParameter("AS_PLANTCODE",      Common.SelectedWorkCenter.PlantCode, DbType.String, ParameterDirection.Input)
                                     , helper.CreateParameter("AS_WORKCENTERCODE", CModule.ToString(lblWC.Tag),         DbType.String, ParameterDirection.Input));
