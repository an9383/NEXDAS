...
namespace NEXDAS
{
    public partial class DX0440 : BaseForm
    {
        #region [ MEMBER AREA ]
        ...
        #region [ FORM EVENT ]
        private void DX0440_Shown(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (CModule.ToString(sender.Tag))
                {
                    case "Confirm":
                        ...
                        try
                        {
                            if (tlpDX0440.GetRowSpan(btnBM0065) == 3)
                            {
                                bSubCode = true;
        ...
        private void Initialization()
        {
            ...
            lblScan_T.BackgroundImage       = (Image)Cmmn.Properties.Resources.ResourceManager.GetObject("DX0440_000");
            ...
            if (dt.Rows.Count == 0)
            {
                tlpDX0440.SetRow(btnBM0065, 3);
                tlpDX0440.SetRowSpan(btnBM0065, 1);
                tlpDX0440.SetColumnSpan(lblWC, 3);
                tlpDX0440.SetColumnSpan(lblOrder, 3);
                btnBM0065.BackColor = Color.White;
            }
            else
            {
                tlpDX0440.SetRow(btnBM0065, 2);
                tlpDX0440.SetRowSpan(btnBM0065, 3);
                tlpDX0440.SetColumnSpan(lblWC, 2);
                tlpDX0440.SetColumnSpan(lblOrder, 2);
